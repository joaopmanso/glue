...
| **M4 Exports** | in-progress (Prepare tab started 2026-09-26: [ADR 0052](../adr/0052-prepare-tab.md), [feature](../features/prepare.md); step 1 waveform, grid, metronome, tempo **shipped 2026-09-26**; next step 2 cues and loops; step 3 rekordbox XML with cues and grid) | Live rekordbox.xml for Rekordbox and Engine DJ (with setup guides), Traktor NML, M3U8, quality policy on export. Feature: [exports](../features/exports.md). |
