...
| **M3 Organise** | planned | Shows and sessions, smart lists, quality tiers and filters, zip backups and restore, undo for deletes, a player bar in the library view. Features: [shows & sessions](../features/shows-sessions.md), [quality tiers](../features/quality-tiers.md). |
...
| **M5 Duplicates** | planned | Fingerprints, duplicate groups, "use preferred copy in all lists". Feature: [duplicates](../features/duplicates.md). |
